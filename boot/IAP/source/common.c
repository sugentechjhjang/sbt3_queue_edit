...
void Main_Menu(void)
{
  ...
  else
  {
    ...
    SerialPutString("\r\n================== Main Menu ============================\r\n\n");
    SerialPutString("  Download Image To the STM32F10x Internal Flash(0x08008000) ------- 1\r\n\n");
    SerialPutString("  Execute The New Program (0x08008000)------------------------------ 2\r\n\n");
    SerialPutString("  Download Image To the STM32F10x Internal Flash(0x08002000) ------- 3\r\n\n");
    SerialPutString("  Execute The New Program (0x08002000)------------------------------ 4\r\n\n");  
    SerialPutString("  Reset ------------------------------------------------------------ 5\r\n\n");  
    SerialPutString("==========================================================\r\n\n");
  }
#endif
  /* Test if any page of Flash memory where program user will be loaded is write protected */
...
#if 0
   // SerialPutString("\r\n============================== Main Menu ==============================\r\n\n");
    SerialPutString("  Download Image To the STM32F10x Internal Flash(0x08002000) ------- 1\r\n\n");
    SerialPutString("  Execute The New Program (0x08002000)------------------------------ 2\r\n\n");  
    SerialPutString("  Reset ------------------------------------------------------------ 3\r\n\n");  
    //SerialPutString("=======================================================================\r\n\n");
#endif
  }
  ...
  while (1)
  {
    ...
    {
        __MSR_MSP(*(int*)ApplicationAddress_1);
      JumpAddress = *(vu32*) (ApplicationAddress_1 + 4);
    ...
    {
        __MSR_MSP(*(int*)ApplicationAddress_2);
      JumpAddress = *(vu32*) (ApplicationAddress_2 + 4);
  ...
  while (1)
  {
    ...
    if (key == 0x31)
    {
     ...
     // __MSR_MSP(0x08002000);
      ...
      /* Jump to user application */
//      JumpAddress = 0x8002000;
      Jump_To_Application = (pFunction) JumpAddress;
      //Jump_To_Application = (pFunction) 0x8002000;
