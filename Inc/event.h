...
hseXaxiAspPosRead=0xA30E,
hseXaxiReserve0=0xA30F,    

hseXaxiReserve1=0x0310,
hseXaxiSamplePosSet=0x0311,
hseXaxiSamplePosRead=0x0312,
hseXaxiBarPosSet=0x0313,
hseXaxiBarPosRead=0x0314,
hseXaxiCamPosSet=0x0315,
hseXaxiCamPosRead=0x0316,
hseXaxiReserve2=0x0317,
hseXaxiReserve

3=0x0318,
hseXaxiSampleWidthSet=0x0319,
hseXaxiSampleWidthRead=0x031A,
hseXaxiClCurrentSet=0x031B,
hseXaxiClCurrentRead=0x031C,
hseXaxiReserve4=0x031D,
hseXaxiReserve5=0x031E,
hseXaxiReserve6=0x031F,

hseXaxiReserve7=0x3020,
hseYaxiHome=0x3021,
hseYaxiSpeedSet=0x3022,
hseYaxiSpeedRead=0x3023,
hseYaxiAccelSet=0x3024,
hseYaxiAccelRead=0x3025,
hseYaxiJogMove=0x3026,
hseYaxiStripWidthSet=0x3027,
hseYaxiStripWidthRead=0x3028,
hseYaxiBathPosSet=0x3029,
hseYaxiBathPosRead=0x302A,  
hseYaxiDspPosSet=0x302B,
hseYaxiDspPosRead=0x302C,
hseYaxiAspPosSet=0x302D,
hseYaxiAspPosRead=0x302E,
hseYaxiBathSamplePosSet=0x302F,

hseYaxiBathSamplePosRead=0x3030,
hseYaxiSamplePosSet=0x3031,
hseYaxiSamplePosRead=0x3032,
hseYaxiClCurrentSet=0x3033,
hseYaxiClCurrentRead=0x3034,
